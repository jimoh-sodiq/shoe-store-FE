    ...
    <main class="border-t">
      ...
      >
        ...
        <h3 class="text-center font-medium uppercase">Reset Password</h3>
          <GlobalInput label="Old Password*" type="email" required />
          <GlobalInput label="New Password*" type="email" required />
          <GlobalButton text="Submit" grow />
          <p class="text-center text-sm">Or</p>
          <NuxtLink to="/auth/login" class="uppercase block w-fit mx-auto text-center font-medium text-sm underline">Login</NuxtLink>
        </form>
      </div>
    </main>
  </template>
