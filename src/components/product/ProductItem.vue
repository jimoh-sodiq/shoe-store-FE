<template>
  <NuxtLink to="/product/kasfjdfk" class="inline-block shrink-0">
    <div class="w-[230px] h-[230px] relative rounded-lg overflow-clip bg-gray-300">
      <NuxtImg class="object-cover w-full h-full"
    ...
    <p class="line-clamp-1 text-gray-700 mt-2 text-sm font-semibold uppercase">
      Ozmorph shoes
    </p>
    <div class="flex items-center gap-x-1 mt-1.5">
      <div class="w-5 h-5 rounded-full bg-blue-600" v-for="color in 3" :key="color" />
    </div>
    <p class="font-bold text-lg mt-1">#5000</p>
  </NuxtLink>
</template>
